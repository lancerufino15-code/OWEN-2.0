/**
 * Citation filtering helpers for OWEN contract responses.
 *
 * Used by: server-side rendering or API responses to enforce allowed source URLs.
 *
 * Key exports:
 ...
 *
 * Assumptions:
 * - Contract body/claims already follow the OWEN contract schema.
 * - URLs are expected to be absolute; invalid URLs are treated as non-allowed.
 */
