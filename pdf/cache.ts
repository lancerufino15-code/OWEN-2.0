 ...
 *
 * Used by: root `index.ts` ingestion flows for manifests and extracted text.
 *
 * Key exports:
 ...
 *
 * Assumptions:
 * - R2 buckets are configured and accessible in the Worker environment.
 * - `fileHash` is a stable digest of PDF bytes; extracted text is stored as UTF-8.
 */
