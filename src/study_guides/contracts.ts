 ...
 */
export const BASE_STUDY_GUIDE_CSS = String.raw`:root { color-scheme: light; --bg-app: #F0F3F2; --bg-app-2: #ECEFED; --bg-surface: #F7F8F6; --bg-surface-alt: #F2F4F2; --bg-surface-hover: #FBFCFA; --text-primary: #1F2A2E; --text-secondary: #5E6B70; --text-muted: #8A9599; --border-subtle: #E2E6E4; --shadow-soft: 0 6px 22px rgba(0, 0, 0, 0.06); --shadow-card: 0 10px 30px rgba(0, 0, 0, 0.06); --shadow-focus: 0 0 0 2px rgba(90, 170, 160, 0.16); }
